...
const Journal = {
    select: [
        {
            sql: `SELECT d.id,
                         ...
                         j.rekvId,
                         to_char(j.kpv, 'YYYY-MM-DD')                         AS kpv,
                         j.asutusid,
                         ...
                         (SELECT ametnik
                          ...
                          WHERE rekvid = j.rekvid
                            AND kasutaja = (d.history -> 0 ->> 'user')::VARCHAR(120)
                          LIMIT 1)::VARCHAR(120)                              AS koostaja
                  FROM docs.doc d
    ...
    grid: {
        gridConfiguration: [
            {id: "id", name: "id", width: "0%", "type": "integer", show: false},
            {id: "kpv", name: "Kuupaev", width: "10%",  interval: true, type: 'date'},
            {id: "asutus", name: "Asutus", width: "15%", "type": "text"},
            {id: "selg", name: "Selgitus", width: "20%", "type": "text"},
            {id: "dok", name: "Dokument", width: "5%", "type": "text"},
            {id: "deebet", name: "Db", width: "5%", "type": "string"},
            {id: "kreedit", name: "Kr", width: "5%", "type": "string"},
            {id: "summa", name: "Summa", width: "10%", "type": "numeric",  interval: true },
            {id: "number", name: "Number", width: "5%", "type": "integer"},
            {id: "created", name: "Lisatud", width: "10%", "type": "date",interval: true},
            {id: "lastupdate", name: "Viimane parandus", width: "10%", "type": "date", interval: true},
            {id: "status", name: "Status", width: "5%", "type": "string"}
        ],
        sqlString: `SELECT j.id,
                           to_char(j.kpv, 'DD.MM.YYYY') AS kpv,
                           j.asutus,
                           j.selg,
                           j.dok,
                           j.deebet,
                           ...
                           $2                           AS user_id
                    FROM cur_journal j
                    WHERE j.rekvId = $1::INTEGER`,     // $1 всегда ид учреждения $2 - всегда ид пользователя
        params: '',
        alias: 'curJournal'
    },
    print: [
        {
            view: 'journal_register',
            params: 'id',
        },
        {
            view: 'journal_register',
